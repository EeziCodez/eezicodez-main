...
!(function (t) {
  ...
  e.addClass("breakpoint-" + f),
    ...
    (INSPIRO.core = {
      ...
      scrollTop: function () {
        ...
        if (a.length > 0) {
          ...
          i.scrollTop() > s
            ? e.hasClass("frame")
              ? a.css({ bottom: "46px", opacity: 1, "z-index": 199 })
              : a.css({ bottom: "26px", opacity: 1, "z-index": 199 })
            : a.css({ bottom: "16px", opacity: 0 }),
            a.off("click").on("click", function () {
              return (
                t("body,html")
                  .stop(!0)
                  .animate({ scrollTop: 0 }, 1e3, "easeInOutExpo"),
                !1
              );
            });
        }
    ...
    (INSPIRO.header = {
            ...
            o.is(".header-disable-fixed") ||
              (r > M + a
                ? (o.addClass("header-sticky"),
                  r > M + s &&
                    (o.addClass("sticky-active"),
                    g.submenuLight &&
                      g.headerHasDarkClass &&
                      (o.removeClass("dark"), (g.headerDarkClassRemoved = !0)),
                    INSPIRO.header.logoStatus()))
                : (o.removeClass().addClass(n),
                  g.sliderDarkClass &&
                    g.headerHasDarkClass &&
                    (o.removeClass("dark"), (g.headerDarkClassRemoved = !0)),
                  INSPIRO.header.logoStatus()));
              ...
              (r > M + a
                ? (o.addClass("header-sticky"),
                  r > M + s &&
                    ...
                    INSPIRO.header.logoStatus()))
                : (o.removeClass().addClass(n),
                  1 == g.headerDarkClassRemoved &&
                    e.hasClass("mainMenu-open") &&
                    o.removeClass("dark"),
                  INSPIRO.header.logoStatus()));
          });
      },
      topBar: function () {
        s.length > 0 &&
          t("#topbar .topbar-dropdown .topbar-form").each(function (e, a) {
            i.width() - (t(a).width() + t(a).offset().left) < 0 &&
              t(a).addClass("dropdown-invert");
          });
      },
      search: function () {
        var i = t("#search");
      ...
      mainMenu: function () {
        if (l.length > 0) {
          l.find(".dropdown, .dropdown-submenu").prepend(
          ...
          s.on("click", function (a) {
              ...
              t(window).breakpoints("lessThan", "lg", function () {
                g.menuIsOpen
                          ...
                          start: function () {
                            ...
                            e.removeClass("mainMenu-open"),
                              ...
                              g.submenuLight &&
                                ...
                                !o.hasClass("header-sticky") &&
                                o.addClass("dark"),
                              g.sliderDarkClass &&
                                g.headerHasDarkClass &&
                                g.headerDarkClassRemoved &&
                                (o.removeClass("dark"),
                                (g.headerDarkClassRemoved = !0));
                          },
                          duration: 500,
                  ...
                  : void (
                      ...
                      ((n = !0),
                      (g.menuIsOpen = !0),
                      g.submenuLight && g.headerHasDarkClass
                        ? (o.removeClass("dark"),
                          (g.headerDarkClassRemoved = !0))
                        : g.headerHasDarkClass &&
                          g.headerDarkClassRemoved &&
            ...
            a.on("click", function (i) {
              t(this).parent("li").siblings().removeClass("hover-active"),
                (e.hasClass("b--responsive") || l.hasClass("menu-onclick")) &&
            ...
            t(window).breakpoints("greaterEqualTo", "lg", function () {
              ...
              s.css("display", "block"),
                t(".dropdown:not(.mega-menu-item) ul ul").each(function (e, a) {
                  i.width() - (t(a).width() + t(a).offset().left) < 0 &&
                    t(a).addClass("menu-invert");
                }),
                a.length > 0 &&
                  i.width() - (a.width() + e.offset().left) < 0 &&
                  a.addClass("menu-last"),
                s.css("display", "");
            });
        }
      },
        ...
        e.length > 0 &&
          (t(window).breakpoints("greaterEqualTo", "lg", function () {
            ...
            "true" == e.attr("data-sticky") &&
              i.scroll(function () {
                i.scrollTop() > t
                  ? (e.addClass("sticky-active"), o.addClass("pageMenu-sticky"))
                  : (e.removeClass("sticky-active"),
                    o.removeClass("pageMenu-sticky"));
              });
          }),
          e.each(function () {
            t(this)
      ...
      currentSection: function () {
        ...
        return (
          a.each(function () {
            var a = t(this),
              s = a.attr("id");
            a.offset().top - i.height() / 3 < i.scrollTop() &&
              a.offset().top + a.height() - i.height() / 3 > i.scrollTop() &&
              (e = s);
          }),
          e
        );
        ...
        if (c.length > 0) {
          ...
          function n(i) {
            ...
            e.each(function () {
              var i = t(this),
                e = "600ms";
              t(this).attr("data-animate-duration") &&
                (e = t(this).attr("data-animate-duration") + "ms"),
                i.css({ opacity: 0 }),
          ...
          function d(t) {
            t.find(".slide.is-selected").hasClass("slide-dark") &&
            g.headerHasDarkClass
              ? (o.removeClass("dark"),
                (g.sliderDarkClass = !0),
                (g.headerDarkClassRemoved = !0))
          ...
          function u(e, a) {
            ...
            var n = i.height(),
              ...
              l =
                (e.hasClass("slider-fullscreen"),
                e.hasClass("slider-halfscreen"),
                o.attr("data-transparent"),
                e.attr("data-height")),
            ...
            function p(t) {
              "null" == t
                ? (e.css("height", ""),
                  r.css("height", ""),
                  e.find(".flickity-viewport").css("height", ""))
                : (e.css("height", t),
                  r.css("height", t),
                  e.find(".flickity-viewport").css("height", t));
            }
            p("null"),
              l &&
                t(window).breakpoints("greaterEqualTo", "lg", function () {
          ...
          c.each(function () {
            ...
            (i.options = {
              ...
              i.find(".slide").length <= 1 &&
                ((i.options.prevNextButtons = !1),
                (i.options.pageDots = !1),
                (i.options.autoPlay = !1),
                (i.options.draggable = !1)),
              t.isNumeric(i.options.autoPlay) ||
                0 == i.options.autoPlay ||
                (i.options.autoPlay = Number(7e3)),
                ...
                on: {
                  ready: function (t) {
                    ...
                    d(i),
                      ...
                      n(e),
                      setTimeout(function () {
                        i.find(".slide:not(.is-selected) video").each(function (
                          t,
                          i
                        ) {
            ...
            e.on("change.flickity", function () {
              ...
              e.on("select.flickity", function () {
                ...
                e
                  ? (e.play(), (a.options.autoPlay = Number(1e3 * e.duration)))
                  : (a.options.autoPlay = Number(i.options.autoPlay));
              }),
        ...
        if ((i && (u = i), u.length > 0)) {
          ...
          u.each(function () {
            ...
            if (
              ...
              (a.options.itemsLg =
                a.options.itemsLg ||
                Math.min(Number(a.options.items), Number(4))),
              (a.options.itemsMd =
                a.options.itemsMd ||
                Math.min(Number(a.options.itemsLg), Number(3))),
              (a.options.itemsSm =
                a.options.itemsSm ||
                Math.min(Number(a.options.itemsMd), Number(2))),
              (a.options.itemsXs =
                a.options.itemsXs ||
                Math.min(Number(a.options.itemsSm), Number(1))),
              s(),
            ...
            1 !== Number(a.options.items)
              ? a.options.autoWidth || o
                ? a
                    .find(".polo-carousel-item")
                    .css({ "padding-right": a.options.margin + "px" })
                : ((e =
                    (a.options.containerWidth + Number(a.options.margin)) / i),
                  a
                    .find(".polo-carousel-item")
                    .css({
                      width: e,
              ...
              : a
                  .find(".polo-carousel-item")
                  .css({ width: "100%", "padding-right": "0 !important;" }),
              (a.options.autoWidth || o) && (a.options.cellAlign = "center"),
              "false" == a.options.autoPlay && (a.options.autoPlay = !1),
              t.isNumeric(a.options.autoPlay) ||
                0 == a.options.autoPlay ||
                (a.options.autoPlay = Number(7e3));
            var n = t(a);
                  ...
                  setTimeout(function () {
                    s(),
                      ...
                      a
                        ...
                        .css({ "margin-right": -a.options.margin / i + "px" }),
    ...
    (INSPIRO.elements = {
                ...
                t.preventDefault(),
                  "text" == i.children("input").attr("type")
                    ? (a.attr("type", "password"),
                      ...
                      e.addClass("fas fa-eye-off"))
                    : "password" == i.children("input").attr("type") &&
                      (a.attr("type", "text"),
                      e.addClass("fas fa-eye"),
                      e.removeClass("fas fa-eye-off"));
              });
          });
      },
            ...
            i.submit(function (n) {
              ...
              !1 === i[0].checkValidity()
                ...
                : (t(i).removeClass("was-validated"),
                  s.html('<i class="fas fa-loader fa-spin"> </i> Sending...'),
                  t.ajax({
                    url: r,
                    type: l,
                    data: d,
                    success: function (n) {
                      if ("success" == n.response)
                        i.find(".g-recaptcha").children("div").length > 0 &&
                          grecaptcha.reset(),
                          s.html(o),
                          a
                            ...
                            : t.notify(
                                { message: e },
                                {
                                  type: "success",
                                  delay:
                                    i.attr("data-success-message-delay") || 2e4,
                                }
                              );
                      else {
                        t.notify(
      ...
      other: function (e) {
        ...
        t(".toggle-item").length > 0 &&
          t(".toggle-item").each(function () {
            ...
            i.on("click", function () {
              return (
                e && (a ? t(a).toggleClass(e) : i.toggleClass(e)),
                i.toggleClass("toggle-active"),
                !1
              );
            });
          });
        ...
        a.length > 0 &&
          a.each(function () {
            ...
            e.find("> a").on("click", function () {
              ...
              i.width() / 2 > e.offset().left &&
                e.addClass("p-dropdown-invert");
          });
      },
      naTo: function () {
        t(
      ...
      accordion: function () {
        ...
        i.length &&
          (i.each(function () {
            var i = t(this);
            i.hasClass("ac-active")
              ? i.addClass("ac-active")
              : i.find(".ac-content").hide();
          }),
          t(".ac-title").on("click", function (i) {
            ...
            return (
              a.hasClass("ac-active")
                ? s.hasClass("toggle")
                  ? (a.removeClass("ac-active"),
                    e.next(".ac-content").slideUp())
                  : (s.find(".ac-item").removeClass("ac-active"),
                    s.find(".ac-content").slideUp())
                : (s.hasClass("toggle") ||
                    (s.find(".ac-item").removeClass("ac-active"),
                    s.find(".ac-content").slideUp("fast")),
                  a.addClass("ac-active"),
                  e.next(".ac-content").slideToggle("fast")),
              i.preventDefault(),
              !1
            );
          }));
          ...
          i.each(function () {
            ...
            i.addClass("animated"),
              (i.options = {
                ...
                direction: ~i.attr("data-animate").indexOf("Out")
                  ? "back"
                  : "forward",
      ...
      shapeDivider: function () {
        t(".shape-divider").each(function () {
          ...
          switch (
            ...
            e.hasClass("dark") &&
              "#ffffff" === i.options.color &&
              (i.options.color = "#181818"),
            i.options.style)
          ) {
            case "1":
              i.options.style =
          ...
          [].forEach.call(n, function (t) {
            ...
            e.hasClass("b--desktop")
              ? i.options.height
                ? o.setAttribute(
                    "style",
                    "height:" + Number(i.options.height).toFixed() + "px"
                  )
                : o.setAttribute(
                    "style",
                    "height:" + Number(o.height.baseVal.value).toFixed() + "px"
                  )
              : i.options.height
              ? o.setAttribute(
                  "style",
                  "height:" + Number(i.options.height).toFixed() / 2 + "px"
                )
              : o.setAttribute(
                  "style",
                  "height:" +
                    Number(o.height.baseVal.value).toFixed() / 2 +
                    "px"
                ),
        ...
        if (i.length > 0) {
          ...
          i.each(function () {
            ...
            (e.options = {
              ...
              window.MAPS &&
                (i = e.options.mapColor ? MAPS[e.options.mapColor] : null),
              e.gmap3({
                center: [
                  Number(e.options.latitude),
                  Number(e.options.longitude),
                ],
          ...
          (e = 1 != INSPIRO.core.rtlStatus()),
            p.each(function () {
              ...
              if (
                ...
                t(window).breakpoints("lessThan", "lg", function () {
                  a.options.gridMargin =
                    a.options.gridMarginXs || a.options.gridMargin;
                }),
                a.css(
                  "margin",
                  "0 -" +
              ...
              var o = t(a).imagesLoaded(function () {
                o.isotope({
                  ...
                  resize: !0,
                  itemSelector:
                    "." + a.options.itemSelector + ":not(.grid-loader)",
                  isOriginLeft: a.options.isOriginLeft,
                  autoHeight: a.options.autoHeight,
                  masonry: {
                    columnWidth: a.find(
                      "." + a.options.itemSelector + ":not(.large-width)"
                    )[0],
                  },
              ...
              a.next().hasClass("infinite-scroll") &&
                INSPIRO.elements.gridLayoutInfinite(
                  a,
                  a.options.itemSelector,
                  a.options.gridMargin
                ),
                m.length > 0 &&
                  m.each(function () {
                    ...
                    if (
                      ...
                      var r = e.find(
                        t('[data-category="' + a.options.filter + '"]')
                      );
                      e.find("li").removeClass("active"),
                        r.parent("li").addClass("active");
                    } else {
                      (r = e.find(t('[data-category="*"]')))
                        .parent("li")
                        .addClass("active");
                    }
                  });
      ...
      gridLayoutInfinite: function (i, e, a) {
        ...
        (s =
          (s = t(".infinite-scroll > a").attr("href")).indexOf(".html") > -1
            ? s.replace(/(-\d+)/g, "-{{#}}")
            : ".infinite-scroll > a"),
          ...
          o.on("error.infiniteScroll", function (i, e, a) {
            ...
            setTimeout(function () {
              ...
              setTimeout(function () {
                t(".infinite-scroll-message").addClass(
          ...
          var e = {
            ...
            inline: {
              ...
              callbacks: {
                ...
                open: function () {
                  t(this.content).find("video").length > 0 &&
                    t(this.content).find("video").get(0).play();
                },
                close: function () {
                  t(this.content).find("video").length > 0 &&
                    t(this.content).find("video").get(0).load();
                },
              },
              fixedContentPos: !0,
              overflowY: "scroll",
      ...
      yTPlayer: function () {
        ...
        if (i.length > 0) {
          ...
          i.each(function () {
            ...
            var e = i.options.videoURL.match(
              /^.*(youtu\.be\/|v\/|u\/\w\/|embed\/|watch\?v=|\&v=)([^#\&\?]*).*/
            );
            e && 11 == e[2].length
              ? (i.options.videoURL = e[2])
              : (i.options.videoURL = i.options.videoURL),
              i.YTPlayer({
                fitToBackground: !0,
                  ...
                  t.magnificPopup.open(
                    {
                      ...
                      callbacks: {
                        ...
                        close: function () {
                          t(this.content).find("video").length > 0 &&
                            t(this.content).find("video").get(0).load(),
                            Cookies.set(o, !0, { expires: Number(a) });
                        },
                      },
                    },
                    0
              ...
              if (
                ...
                setTimeout(function () {
                  1 != l
                    ...
                    : void 0 === Cookies.get(r) && o.addClass("modal-active");
                }, e);
                n.click(function () {
                  return (
                    Cookies.set(r, !0, { expires: Number(a) }),
                    t.magnificPopup.close(),
                    o.removeClass("modal-active"),
                    !1
                  );
                });
              }
      ...
      notification: function (i, e, a, s, o, n, r, l, d, c) {
        ...
        (n = n || "top"),
          s
            ? ((u = "element-container"), (r = "fadeIn"), (l = "fadeOut"))
            : (u = "col-11 col-md-4"),
          d &&
            (p =
            ...
            (i.options = {
              ...
              i.theiaStickySidebar({
                ...
                additionalMarginBottom: Number(
                  i.options.additionalMarginBottom
                ),
              ...
              (r = "true" == r ? "{{avatar}}" : ""),
                ...
                i
                  ...
                  .twittie(
                    ...
                    function () {
                      i.parents(".grid-layout").length > 0 &&
                        i.parents(".grid-layout").isotope("layout");
                    }
                  );
            });
          }, 2e3);
              ...
              i.jflickrfeed(
                ...
                function () {
                  ...
                  e.magnificPopup(
                    ...
                    function () {
                      e.parents(".grid-layout").length > 0 &&
                        e.parents(".grid-layout").isotope("layout");
                    }
                  );
                }
              );
          ...
          i.each(function () {
            ...
            i.submit(function (o) {
              ...
              !1 === i[0].checkValidity()
                ...
                : (t(i).removeClass("was-validated"),
                  a.html('<i class="fas fa-loader fa-spin"></i>'),
                  t.ajax({
                    url: n,
                    type: r,
                    data: l,
                    ...
                    success: function (o) {
                      "success" == o.response
                        ? (t.notify({ message: e }, { type: "success" }),
                          t(i)[0].reset(),
                          t(i).removeClass("was-validated"),
                          a.html(s))
                        : (t.notify(
